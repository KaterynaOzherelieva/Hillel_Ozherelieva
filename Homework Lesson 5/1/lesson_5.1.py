...
for keys, values in car_data.items():
    if values[1] >= search_criteria[0] and values[2] >= search_criteria[1] and values[4] <= search_criteria[2]:
        matching_cars.append((keys, values))
# print(matching_cars)

matching_cars_sorted = sorted(matching_cars, key=lambda car: car[1] [4])
# print(matching_cars_sorted)

top_5_cars = matching_cars_sorted[:5]
